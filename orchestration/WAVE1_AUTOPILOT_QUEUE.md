...
| B | Polish Localization Engine | AUTO + VERIFY through calibration | Branch reconciled with main at `10b8189`; regression PASS across 7 accepted fixtures / 37,159 candidate chars. Gentle Steps source-side spot check PASS; only real-template overflow/fit for the four longest Week 1 headings remains before Week 1 promotion. Detective full-book PL still waits for explicit EN freeze. | English Detective freeze before full Detective PL; Gentle Steps real-template layout-fit before Week 1 promotion/full segmented scale-out. |
| C1 | Detective Academy | OWNER REVIEW / RELEASE GATE | **FINAL ENGLISH INTERIOR PASS** at `6aef8ce`: 141-page PDF generated, 141 print-scale previews generated, KDP preflight PASS, Build #93 PASS, SEO #551 PASS. Product engineering is release-ready. Do not reopen maps/story/naming. Next is owner visual review of previews, final cover/proof, then controlled KDP upload/publication. | KDP upload/publication, pricing, final cover and physical proof remain owner-only gates. |
