...
No product truth, locked Shigai geometry, map-system decision, naming rule or Witness Board decision was reopened.
...
- TikTok: not verified connected
- Creative Claw: must be verified immediately before any next paid generation

Connector state remains VERIFY-ON-USE.
...
This is an execution-efficiency decision, not a change to product positioning.
