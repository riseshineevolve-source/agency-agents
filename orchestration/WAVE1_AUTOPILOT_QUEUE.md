...
| C1 | Detective Academy | AUTO + VERIFY through ALL-15 / preflight | Pilot Witness Board + map family is PASS on HMDA_02 / HMDA_13 / HMDA_29; all-15 geometry/meta/alias checks are green and no new design gate is required for mechanical scale. Continue safe ALL-15 validation, canonical book attachment, final interior and KDP preflight. Preserve any local unpushed Codex work before reset/pull/restart. | KDP upload/publication, pricing, final cover and physical proof remain owner-only gates. |
